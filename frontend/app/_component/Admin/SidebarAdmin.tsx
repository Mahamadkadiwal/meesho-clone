...
export default function SidebarAdmin() {
    const sidebarLinks: MenuItem[] = [
        { name: "Category", icon: <TbCategory />, link: "/admin/category" },
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <nav>
                    {sidebarLinks.map((link, index) => (
                        <Link href={link.link} key={index} className=" w-full flex items-center gap-3 px-4 py-2 text-(--sidebar-link-text) hover:bg-(--sidebar-link-hover-bg)">
